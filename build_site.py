...
def build_gallery_page(gallery_keys: tuple[str, ...], title: str, description: str, out_file: str):
  ...
  <section class=\"gallery-header\">
    ...
    <p class="muted">Browse ethical wildlife photography captured across grasslands, wetlands, and forest habitats with species-focused captions for discovery.</p>
...
def build_documentaries_page():
  ...
  <section class=\"gallery-header\">
    ...
    <p class="muted">Watch conservation films that highlight biodiversity, threatened species, habitat pressures, and community-led protection efforts across India.</p>
  </section>
